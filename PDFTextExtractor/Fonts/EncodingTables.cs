...
{
    //internal class Font_Old
    //{
    //    PdfDictionary font;

    //    /*
    //     * TODO: as font is visual aspect, it is tied to which graphics library your using.
    //     * Im currently looking for a Open source Font library. untill then im using WPF GlyphTypeface for Calucluating Glyph size
    //     * 
    //     * to make this easy to swich over im using the Dependency Injection
    //     */
    //    GlyphSizeFinder glyphSizeFinder;
    ...
    //    public Font_Old(PdfDictionary dictionary, Func<string, GlyphSizeFinder> glyphSelector)
    //    {
    //        font = dictionary;

    //        if (font.Elements.ContainsKey("/BaseFont"))
    //        {
    //            PdfItem item = font.Elements["/BaseFont"];
    //            if (item is PdfReference)
    //                BaseFont = (item as PdfReference).Value.ToString().TrimStart('/');
    //            else
    //                BaseFont = item.ToString().TrimStart('/');
    //        }

    //        glyphSizeFinder = glyphSelector(BaseFont);

    //        if (font.Elements.ContainsKey("/Encoding"))
    //        {
    ...
    //        if (font.Elements.ContainsKey("/Subtype"))
    //        {
    ...
    //        if (font.Elements.ContainsKey("/ToUnicode"))
    //        { // parse to unicode
    ...
    //    public double GetGlyphWidth(char c) => glyphSizeFinder != null ? glyphSizeFinder.GetGlyphWidth(c) : 1;

    //    public double GetGlyphHeight(char c) => glyphSizeFinder != null ? glyphSizeFinder.GetGlyphHeight(c) : 1;
    //}

    //public abstract class GlyphSizeFinder
    //{
    //    public GlyphSizeFinder(string baseName)
    //    {

    //    }

    //    public abstract double GetGlyphWidth(char c);
    //    public abstract double GetGlyphHeight(char c);
    //}

    //public class BaseGlyphFinder : GlyphSizeFinder
    //{
    //    public BaseGlyphFinder(string baseName) : base(baseName)
    //    {

    //    }

    //    public override double GetGlyphWidth(char c) => 0.75;
    //    public override double GetGlyphHeight(char c) => 0.75;
    //}

    /*
     * This Lovely Class was take from a similar project, i will track down Link:
     * https://github.com/alexarchen/PdfSharpTextExtractor/blob/master/EncodingTables.cs
     */
    internal static class EncodingTables
    {
        ...
        static Dictionary<ushort, string> Convert(string[] encoding)
        {
            ...
            foreach (string s in encoding)
            {
                if (s != NULL)
                {
                    if (ToUnicode.TryGetValue(s, out char c))
                        res.Add(key, "" + c);
                }
                key++;
            }
